                                                    ...
                                                    <div
                                                        ...
                                                        <div class="display-pictute text-center">
                                                            <div class="mb-0 mx-auto position-relative"><img
                                                                    ...
                                                                    src="{{ getURL($profile->img) }}" id="output" />
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="email"
                                                            ...
                                                            value="{{ $profile->email }}" placeholder="ABC">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text"
                                                            ...
                                                            value="{{ $profile->designation }}" placeholder="ABC">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text"
                                                            ...
                                                            value="{{ $profile->address }}" placeholder="ABC">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text"
                                                            ...
                                                            value="{{ $profile->phone }}" placeholder="ABC">
