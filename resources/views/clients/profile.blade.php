                        ...
                        <div class="col-lg-12 h-100">
                            <div class="box mb-3 box-p">
                                <div class="flex-grow-1">
                                    ...
                                    <form action="{{ route('client.update', $profile->id) }}" method="POST"
                                        ...
                                        <div class="">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text"
                                                            class="form-control crm-input {{ $errors->has('business_name') ? 'is-invalid' : '' }}"
                                                            id="business_name" name="business_name"
                                                            value="{{ $profile->business_name }}" placeholder="Mickel"
                                                            required>
                                                        <label class="crm-label form-label" for="business_name">Business
